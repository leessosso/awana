          ...
          <Card>
            ...
            <CardContent>
              <form className="grid gap-4 md:grid-cols-2" onSubmit={handleCreateTeacher}>
                ...
                >
                  <SelectTrigger>
                    <SelectValue placeholder="소속 담임 선택 (보조 선생님만)" />
                  </SelectTrigger>
                  <SelectContent>
                ...
                >
                  <SelectTrigger>
                    <SelectValue placeholder="소속 클럽 선택 (운영 선생님은 없음)" />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="none">클럽 없음</SelectItem>
                ...
                >
                  <SelectTrigger>
                    <SelectValue placeholder="소속 팀 선택 (운영 선생님은 없음)" />
                  </SelectTrigger>
                  <SelectContent>
